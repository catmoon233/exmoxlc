...
public class PlayerspawnsxsetProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if (!(((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE).getModifier(UUID.fromString("01d39f67-32f1-420d-b0fb-76d884db52e9")) != null)) {
			if (!(((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE).hasModifier((new AttributeModifier(UUID.fromString("01d39f67-32f1-420d-b0fb-76d884db52e9"), "\u521D\u59CB\u653B\u51FB",
				...
				((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE).addPermanentModifier((new AttributeModifier(UUID.fromString("01d39f67-32f1-420d-b0fb-76d884db52e9"), "\u521D\u59CB\u653B\u51FB",
						((entity.getCapability(ExmoxlModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new ExmoxlModVariables.PlayerVariables())).playerattack - 1), AttributeModifier.Operation.ADDITION)));
		}
	}
}
